...
def extract_invoice_data(pdf_path):
    ...
    with pdfplumber.open(pdf_path) as pdf:
        ...
        # --- HEADER EXTRACTION (hard-coded patterns for your samples) ---
        # Invoice Number
        ...
        for page in pdf.pages:
            ...
            for table in tables:
                # Heuristic: look for tables with at least 5 columns and header row containing 'Description' or 'Product'
        ...
        # Add more fields as needed based on your invoice format
...
def save_to_excel(header_data, line_items, output_path):
    ...
    # Write line items to second sheet
...
if __name__ == "__main__":
    input_pdf = "invoice3.pdf"  # Change to your PDF file
    output_excel = "extracted_invoice3.xlsx"
